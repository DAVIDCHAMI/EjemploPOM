...
import com.sura.reclamaciones.steps.guidewire.claimscenter.soat.NuevoAvisoSiniestroSoatStep;
...
public class CreacionPolizaSoatDefinition {
  ...
  @Steps NuevoAvisoSiniestroSoatStep reclamacionStep;
  ...
  public void consultarPolizar() throws IOException {
    reclamacionStep.consultarPolizaSoat(
